...
public class LoginExclusaoView extends JFrame implements ControllerAcesso {
	...
	public LoginExclusaoView() {
		...
		JLabel lblCargo = new JLabel("Cargo ocupado na Empresa");
		...
		separator_2.setBounds(0, 367, 794, 5);
